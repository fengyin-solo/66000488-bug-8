...
const REGION_VALUES = ['all', 'alpha-helix', 'beta-sheet', 'left-helix', 'disallowed'];
export const useProteinStore = defineStore('protein', () => {
    ...
    // 再次点击同一条记录即取消选中
    function selectConformation(conf) {
    ...
    function filterByRegion(region) {
        selectedRegion.value = REGION_VALUES.includes(region) ? region : 'all';
        pruneSelection();
    }
    return {
        loading,
